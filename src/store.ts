...
export declare class BlobStore {
     ...
     */
    public exists(opts: BlobKey, cb: (error: Error | undefined, exists: boolean) => void): void

    /**
     * This checks if a blob exists in the store.
     */
    public remove(opts: BlobKey, cb: (error: Error | undefined, exists: boolean) => void): void
